...
### Fixed
- **GoReleaser Configuration**: Fixed terraform registry manifest file handling in release process
- **Release Assets**: Corrected missing manifest.json asset generation for Terraform Registry compatibility
